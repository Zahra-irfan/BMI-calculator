...
if (bmi.height > 0 && bmi.weight > 0) {
    if (bmi.unit === "feet") {
        let heightMeters = bmi.height / 3.28084;
        ...
        if (result < 25 && result > 18.5) {
            console.log("Your body mass index (BMI) shows that you are at a healthy weight! [*^-^*]");
        }
        else if (result >= 30) {
            console.log("According to your body mass index (BMI), you're obeese! [^~^']");
        }
        else if (result < 18.5) {
            console.log("Your body mass index (BMI) shows that you're underweight! [^~^']");
        }
        else if (result > 25 && result < 30) {
            console.log("Your body mass index shows that you're overweight but not obeese! [^-^]");
        }
    }
    else if (bmi.unit === "meters") {
        let heightMeters = bmi.height;
        let result = bmi.weight / heightMeters ** 2;
        console.log(`Your BMI (Body Mass Index) is: "${result.toFixed(2)}kg/m^2"`);
        if (result < 25 && result > 18.5) {
            console.log("Your body mass index (BMI) shows that you are at a healthy weight! [*^-^*]");
        ...
        let heightMeters = bmi.height * 0.0254;
        let result = bmi.weight / heightMeters ** 2;
        console.log(`Your BMI (Body Mass Index) is: "${result.toFixed(2)}kg/m^2"`);
        if (result < 25 && result > 18.5) {
            console.log("Your body mass index (BMI) shows that you are at a healthy weight! [*^-^*]");
        ...
        let heightMeters = bmi.height / 100;
        let result = bmi.weight / heightMeters ** 2;
        console.log(`Your BMI (Body Mass Index) is: "${result.toFixed(2)}kg/m^2"`);
        if (result < 25 && result > 18.5) {
            console.log("Your body mass index (BMI) shows that you are at a healthy weight! [*^-^*]");
